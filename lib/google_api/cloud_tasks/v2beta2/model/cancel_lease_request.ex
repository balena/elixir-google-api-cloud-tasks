...
defmodule GoogleApi.CloudTasks.V2beta2.Model.CancelLeaseRequest do
  ...
  - scheduleTime (String.t): Required.  The task&#39;s current schedule time, available in the schedule_time returned by LeaseTasks response or RenewLease response. This restriction is to ensure that your worker currently holds the lease. Defaults to: `null`.
  """
